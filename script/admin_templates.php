...
<html>
    <head>
        <title>B2BCoin.xyz Faucet</title>
    ...
    <body>
        <div class="container">
        <h1 class="text-center">Welcome to your B2BCoin.xyz Faucet Admin Page!</h1><hr>
        <:: content ::>
        </div>
    </body>
</html>
...
These lists should be saved in <code>/libs/ips/cloudflare.txt</code> and <code>/libs/ips/incapsula.txt</code> respectively. Each line should hold exactly one network in CIDR notation.</div>
                    <p>This setting allows you to change the method of identifying users. By default B2BCoin.xyz Faucet will use the connecting IP address. Hovewer if you're using a reverse proxy, like CloudFlare or Incapsula, the connecting IP address will always be the address of the proxy. That results in all faucet users sharing the same timer. If you enable this option, B2BCoin.xyz Faucet will use a corresponding HTTP Header instead of IP address.</p>
            ...
            <div role="tabpanel" class="tab-pane" id="referrals">
                ...
                <div class="alert alert-danger hidden" id="referral-ajax-error">
                    An error occurred while receiving addresses with this referral. Please try again later or contact <a href="https://b2bcoin.xyz/#footer" target="_blank">support team</a>.
                </div>
        ...
        <div class="col-md-4 text-center">
            <div class="form-group">
                <p class="small text-muted">
                    <br>
                    B2BCoin.xyz Faucet <:: fiab_version ::>
                </p>
            </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Your server's settings are too strict to run B2BCoin.xyz Faucet correctly. Please increase PHP's <code>post_max_size</code> and/or Apache's <code>LimitRequestBody</code>.</p>
    ...
    function reloadSendCoinsConfirmation() {
        ...
        var bitcoin = satoshi / 1000000000000;
...
<form method="POST">
    ...
    <div class="alert alert-info alert-dismissible" role="alert">
        ...
        <span style="line-height: 34px">
            There's a new version of B2BCoin.xyz Faucet available!
...
<p class="alert alert-success">
    <span class="glyphicon glyphicon-ok"></span>
    B2BCoin.xyz Faucet script was successfully updated to the newest version!
</p>
TEMPLATE;
...
<p class="alert alert-danger">
    <span class="glyphicon glyphicon-remove"></span>
    An error occurred while updating B2BCoin.xyz Faucet script. Please install new version manually.
</p>
TEMPLATE;
...
<p class="alert alert-danger">Error connecting to <a href="https://api.b2bcoin.xyz">B2BCoin.xyz API</a>. Either your hosting provider doesn't support external connections or B2BCoin.xyz API is down. Send an email to <a href="mailto:support@b2bcoin.xyz">support@b2bcoin.xyz</a> if you need help.</p>
TEMPLATE;
...
<p class="alert alert-danger">You have to provide an API key, enable captcha and add rewards to enable your faucet.</p>
TEMPLATE;
...
<div class="alert alert-warning">
    <b>Your template file is out of date and won't work with this version of B2BCoin.xyz Faucet. Here's what you have to do to fix that:</b>
    <:: template_updates ::>
<hr>
</div>
TEMPLATE;
